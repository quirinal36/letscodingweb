"""
Django settings for letscodingweb project.
...
MIDDLEWARE = [
    ...
    'django_session_timeout.middleware.SessionTimeoutMiddleware', # 로그인 세션
...
SESSION_TIMEOUT_REDIRECT = '/reservation/'

ROOT_URLCONF = 'letscodingweb.urls'
...
WSGI_APPLICATION = 'letscodingweb.wsgi.application'
